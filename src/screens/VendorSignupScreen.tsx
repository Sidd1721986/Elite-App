...
// Minimal signup: name, email, password. Business details (address, phone) are
// collected on the vendor profile after approval instead of up front.
const VendorSignupScreen: React.FC<Props> = ({ navigation }) => {
    ...
    const handleSignup = async () => {
        ...
        setLoading(true);
        const result = await signup(name, email, password, UserRole.VENDOR);

        if (result === true) {
            showMessage('Account created! Please wait for Admin approval.');
            signupTimeoutRef.current = setTimeout(() => {
                setLoading(false);
                navigation.navigate('Login', { initialRole: UserRole.VENDOR });
            }, 2000);
        } else {
            setLoading(false);
                    ...
                    >
                        <View style={styles.content}>
                            ...
                            <Text variant="bodyLarge" style={styles.subtitle}>
                                Create your account to offer services
                            </Text>
                            ...
                            <Card style={styles.card}>
                                <Card.Content>
                                    <TextInput
                                        ...
                                        testID="vendor_signup_name_input"
                                    />
                                    ...
                                    <TextInput
                                        ...
                                        testID="vendor_signup_email_input"
                                    />
                                    ...
                                    <TextInput
                                        ...
                                        testID="vendor_signup_password_input"
                                    />
                                    ...
                                    <Button
                                        ...
                                        testID="vendor_signup_submit_btn"
                                    >
                                        Create Vendor Account
                                    </Button>

                                    <SocialAuthButtons role={UserRole.VENDOR} onMessage={showMessage} />
