...
namespace EliteApp.API.Migrations
{
    ...
    [Migration("20260803162944_AddPasswordChangedAtAndResetAttempts")]
    partial class AddPasswordChangedAtAndResetAttempts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EliteApp.API.Models.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EliteApp.API.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("PhoneVerificationLastAttempt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("EliteApp.API.Models.Payment", b =>
                {
                    b.HasOne("EliteApp.API.Models.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
